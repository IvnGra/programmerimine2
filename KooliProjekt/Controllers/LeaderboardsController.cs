...
namespace KooliProjekt.Controllers
{
    public class LeaderboardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TournamentId,UserId,Total_id,Name")] Leaderboard leaderboard)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.User, "Id", "Username", leaderboard.UserId);
            return View(leaderboard);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TournamentId,UserId,Total_id,Name")] Leaderboard leaderboard)
        {
